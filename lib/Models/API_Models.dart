import 'dart:convert';
/// updated : 1672320221714
/// cases : 663628632
/// todayCases : 320509
/// deaths : 6692402
/// todayDeaths : 717
/// recovered : 635721927
/// todayRecovered : 185413
/// active : 21214303
/// critical : 39695
/// casesPerOneMillion : 85137
/// deathsPerOneMillion : 858.6
/// tests : 6880657949
/// testsPerOneMillion : 866043.46
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2670.17
/// recoveredPerOneMillion : 80016.01
...
ApiModels copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => ApiModels(  updated: updated ?? _updated,
  cases: cases ?? _cases,
